...
| `product-management/synthesize/` | `synthesize-research` | `/synthesize-research` slash command |
...
- `synthesize-research` takes interview/feedback notes and outputs structured thematic findings.
